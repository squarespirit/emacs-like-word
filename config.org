...
(defun pop-and-jump-to-mark ()
  "Go to previous mark position."
  (interactive)
  (cua-set-mark '(4)))
;; Note: usual keys (alt-left/right) can't be bound because
;; org mode uses them
(global-set-key (kbd "M--") 'pop-and-jump-to-mark)
...
** Completion
#+BEGIN_SRC emacs-lisp
;; Sacrilege! I have rebound the mark command
